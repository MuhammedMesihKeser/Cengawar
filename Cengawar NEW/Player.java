...
public class Player {
	...
	//CONSTRUCTOR
	Player(int cengman_capacity, int tree_capacity,  int wall_capacity)
	{
	...
	public void createCengMAN()
	{
		...
		if(base.getFood()>=CengMAN.food_cost)//&&Counter==0
		{
			base.setFood(base.getFood()-50);
			cengman[cengman_amount]=new CengMAN(true);
			cengman_amount++;
		}
	}
	public void createTree()
	{
		...
		{
			base.setFood(base.getFood()-50);
			tree[tree_amount]=new Tree(true);
			tree_amount++;
		}
	}
	...
	{
		base.setCounter(Integer.valueOf(base.getBase_commands().peek().toString().substring(1)));
